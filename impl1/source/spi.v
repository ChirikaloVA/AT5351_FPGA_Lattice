...
/* Module Version: 1.2 */
/* C:\Program Files\LSCC\diamond\3.7\ispfpga\bin\nt\scuba.exe -w -n SPI -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 12 -spi -spi_mode Slave -spi_lsb -ufm -ufm_ebr 510 -mem_size 1 -ufm_0 -wb -dev 1200  */
/* Fri Dec 23 15:34:44 2016 */
...
module SPI (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    ufm_sn, wbc_ufm_irq)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .PLLDATO1(), .PLLDATO0(), .I2C1SCLO(), .I2C1SCLOEN(), .I2C1SDAO(), 
        ...
        .SPICSNEN(), .SPIIRQO(), .TCINT(), .TCOC(), .WBCUFMIRQ(wbc_ufm_irq), 
        .CFGWAKE(), .CFGSTDBY());
