...
/* Module Version: 5.8 */
/* C:\Program Files\LSCC\diamond\3.7\ispfpga\bin\nt\scuba.exe -w -n FIFO -lang verilog -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 8 -width 24 -rwidth 24 -regout -resetmode SYNC -no_enable -pe 1 -pf 7 -sync_reset  */
...
module FIFO (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam FIFO_0_1.REGMODE = "OUTREG" ;
    ...
    FIFO8KB FIFO_0_1 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), .DI3(Data[3]), 
        ...
        .DI17(Data[17]), .CSW0(scuba_vhi), .CSW1(scuba_vhi), .CSR0(RdEn), 
    ...
    defparam FIFO_1_0.REGMODE = "OUTREG" ;
