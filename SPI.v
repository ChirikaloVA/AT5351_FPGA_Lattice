...
/* Module Version: 1.2 */
/* C:\Program Files\LSCC\diamond\3.7\ispfpga\bin\nt\scuba.exe -w -n SPI -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 12 -spi -spi_mode Slave -spi_clkinv -spi_rxr -spi_en -wb -dev 2000  */
...
module SPI (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    defparam EFBInst_0.SPI_CLK_INV = "ENABLED" ;
